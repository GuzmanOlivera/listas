 ...
 *  */ 
    ...
    $arrayCabeceraDocente = array('ciTAS','seccion'); //FIXME: hacer dinamico
    ...
    $stringCondicionDocente = "ciTAS=" . $ci;
    ...
    $sql = "UPDATE tas SET " . $stringColValDocente . " WHERE " . $stringCondicionDocente . ";" ;
    echo $sql;
    echo "<br>";
    $colField = $dbh->prepare($sql);
    $colField->execute();
